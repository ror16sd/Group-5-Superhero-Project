...
Insert into super Values(superId, superName, powerId, heroDescription, isHero),
(8,'Superman', 2, 'Americas Hero', 1), 
(9, 'The Joker', 5, 'Pure psychopath', 0);

Insert into super_Org Values (superId , organizationId),
(8, 8), (9, 0);
